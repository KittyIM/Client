...
void Kitty::RosterSettings::apply()
{
  ...
  core->setSetting(Settings::S_ROSTER_PHONE_ICON, m_ui->phoneIconCheckBox->isChecked());
  core->setSetting(Settings::S_ROSTER_EMAIL_ICON, m_ui->emailIconCheckBox->isChecked());
...
void Kitty::RosterSettings::reset()
{
  ...
  m_ui->phoneIconCheckBox->setChecked(core->setting(Settings::S_ROSTER_PHONE_ICON, true).toBool());
  m_ui->emailIconCheckBox->setChecked(core->setting(Settings::S_ROSTER_EMAIL_ICON, true).toBool());
